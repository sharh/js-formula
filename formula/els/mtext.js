...
Mtext.prototype.getAttr = function(attrName) {
	return this.$element.attr(attrName);
};

Mtext.prototype.getAttrs = function(attrName) {
	return this.attrs;
};

Mtext.prototype.setAttr = function(attrName, value) {
	return this.element.setAttribute(attrName, value);
};

Mtext.prototype.getBox = function() {
